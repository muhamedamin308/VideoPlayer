(function (root, factory) {
        ...
        switch (this.state_0) {
          case 0:
            ...
            if (this.$this.lexer_0.peekNextToken() === TC_COMMA)
              this.$this.lexer_0.fail_bm4lxs$('Unexpected leading comma');
          ...
          case 3:
            ...
            switch (this.local$lastToken) {
              ...
              case 7:
                break;
              default:
                this.$this.lexer_0.fail_bm4lxs$('Expected end of the object or comma');
                break;
            }
          ...
          case 4:
            if (this.local$lastToken === TC_BEGIN_OBJ) {
              ...
              this.$this.lexer_0.fail_bm4lxs$('Unexpected trailing comma');
            }
  ...
  JsonTreeReader.prototype.read = function () {
    ...
    switch (token) {
      ...
      case 8:
        ...
        break;
      default:
        tmp$_0 = this.lexer_0.fail_bm4lxs$('Cannot begin reading element, unexpected token: ' + token);
        break;
    }
    return tmp$_0;
  };
        ...
        switch (this.state_0) {
          case 0:
            switch (this.local$this$JsonTreeReader.lexer_0.peekNextToken()) {
              ...
              default:
                return this.local$this$JsonTreeReader.lexer_0.fail_bm4lxs$("Can't begin reading element, unexpected token");
            }
  ...
  AbstractJsonLexer.prototype.expectEof = function () {
    ...
    if (nextToken !== TC_EOF)
      this.fail_bm4lxs$('Expected EOF after parsing, but had ' + String.fromCharCode(this.source.charCodeAt(this.currentPosition_0 - 1 | 0)) + ' instead');
  };
  ...
  AbstractJsonLexer.prototype.unexpectedToken_0 = function (expected) {
    ...
    if (this.currentPosition_0 >= 0 && expected === STRING && equals(this.consumeStringLenient(), NULL)) {
      this.fail_bm4lxs$("Expected string literal but 'null' literal was found.\nUse 'coerceInputValues = true' in 'Json {}` builder to coerce nulls to default values.", this.currentPosition_0 - 4 | 0);
    }
  ...
  AbstractJsonLexer.prototype.fail_8e99oo$ = function (expectedToken) {
    ...
    this.fail_bm4lxs$('Expected ' + expected + ", but had '" + s + "' instead", this.currentPosition_0 - 1 | 0);
  };
  ...
  AbstractJsonLexer.prototype.consumeStringLenientNotNull = function () {
    ...
    if (equals(result, NULL) && this.wasUnquotedString_0()) {
      this.fail_bm4lxs$("Unexpected 'null' value instead of string literal");
    }
    return result;
  };
  ...
  AbstractJsonLexer.prototype.consumeStringLenient = function () {
    ...
    if (token !== TC_OTHER) {
      this.fail_bm4lxs$('Expected beginning of the string, but got ' + String.fromCharCode(this.source.charCodeAt(current)));
    }
    var usedAppend = false;
  ...
  AbstractJsonLexer.prototype.appendEsc_0 = function (startPosition) {
    ...
    currentPosition = this.prefetchOrEof_za3lpa$(currentPosition);
    if (currentPosition === -1)
      this.fail_bm4lxs$('Expected escape sequence to continue, got EOF');
      ...
      switch (lastToken) {
        ...
        case 9:
          if (last(tokenStack) !== TC_BEGIN_LIST)
            throw JsonDecodingException_1(this.currentPosition_0, 'found ] instead of }', this.source);
  ...
  AbstractJsonLexer.prototype.fail_bm4lxs$ = function (message, position) {
    if (position === void 0)
      position = this.currentPosition_0;
    throw JsonDecodingException_1(position, message, this.source);
  };
  ...
  AbstractJsonLexer.prototype.consumeBoolean2 = function (start) {
    ...
    switch (this.source.charCodeAt((tmp$ = current, current = tmp$ + 1 | 0, tmp$)) | 0 | 32) {
      ...
      case 102:
        ...
        break;
      default:
        tmp$_0 = this.fail_bm4lxs$("Expected valid boolean literal prefix, but had '" + this.consumeStringLenient() + "'");
        break;
    }
    return tmp$_0;
  };
  ...
  JsonStringBuilder.$metadata$ = {kind: Kind_CLASS, simpleName: 'JsonStringBuilder', interfaces: []};
